...
public class Message {
    ...
    // When Messages are created, addToFile is set to true, in order to add it to
    // the text file.
    // Messages retrieved from an existing file will have addToFile = false,
    // ensuring they are not duplicated in the
    // text files.
    ...
    // This constructor generates message objects given the parameters. This is only
    ...
    // Setter for the nextMessageID which is called when messages are created to
    ...
    // Method that is used to edit the content of a message, and requests the
    // database to edit the file.
    public void editMessage(String msgContent) {
        this.content = msgContent;

        if (this.database.isServer()) {
            this.database.editMessageInConversationFile(this.getId(), this.content);
        }
    }
