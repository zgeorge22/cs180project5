...
/*
        ...
        System.out.println("OIS works"); //TODO - Fix so database can be sent from server

 */

        String exit = "false";
        do { //TODO IMPORTANT - Client do-while loop must start if it receives a GUI command line OR a server prompt. Currently only starts with GUI command line
